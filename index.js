							...
							// Command
								...
								case 0x6B:
									...
									while (l < labels_in_part) {
										...
										if (data[2] == 0x6A) {
											// sources
											self.source_names.splice( (label_number - 1), 0, { id: label_number.toString(), label: label_number.toString() + ': ' + label.trim() } )
										}
										else if (data[2] == 0x6B) {
											// destinations
											self.dest_names.splice( (label_number - 1), 0, { id: label_number.toString(), label: label_number.toString() + ': ' + label.trim() } )
										}
