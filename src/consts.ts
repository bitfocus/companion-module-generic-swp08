...
export const feedbackOptions = {
	...
	level: {
		...
		default: 1,
		choices: [],
		expressionDescription: 'Expression should return a level number',
	},
	destination: {
		type: 'number',
		label: 'Destination',
		...
		min: 1,
		max: 65536,
		expressionDescription: 'Expression should return a destination number',
		asInteger: true,
		step: 1,
		clampValues: false,
	},
	...
	source: {
		...
		min: 1,
		max: 65536,
		expressionDescription: 'Expression should return a source number',
		asInteger: true,
		step: 1,
		clampValues: false,
	},
...
export const actionOptions = {
	...
	clear: {
		...
		expressionDescription: 'Options: all | level | dest | source',
	},
	clearEnableLevels: {
		type: 'checkbox',
